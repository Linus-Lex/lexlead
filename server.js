  ...
  <div class="settings" id="profile-panel">
    <div class="set-card">
      ...
      <div class="notice">
        ...
        bekommst du sofort eine SMS auf dein Handy. Dafür brauchst du einen kostenlosen
        Twilio-Account (twilio.com) — ca. 1 Cent pro SMS.<br><br>
        <strong>Twilio einrichten:</strong> twilio.com → kostenlosen Account erstellen →
        eine Telefonnummer kaufen (~1$/Monat) → SID und Token in Render unter
        "Environment" eintragen als TWILIO_SID, TWILIO_TOKEN, TWILIO_FROM.
      </div>
      ...
      <div class="field">
        <label>Deine Handynummer für SMS-Alerts (mit Ländercode)</label>
    ...
    <div class="set-card">
      <div class="set-title">ImmoScout24 Weiterleitung einrichten</div>
      <div class="notice" style="border-color:#1a3a1a;background:#0a1f0a">
        <strong>So funktioniert es:</strong> ImmoScout schickt dir bei jeder Anfrage automatisch eine E-Mail.
        Du verbindest einfach dein E-Mail-Postfach in LexLead — fertig. LexLead erkennt
        ImmoScout-Mails automatisch und analysiert sie speziell als Portal-Anfragen.<br><br>
        <strong>Kein extra Setup nötig</strong> — sobald dein Postfach verbunden ist, werden
        alle ImmoScout-Anfragen automatisch erfasst. Gleiches gilt für Immowelt und Kleinanzeigen.
      </div>
    </div>
  </div>
</div>
...
async function openLead(id) {
  ...
  document.getElementById('dp-body').innerHTML = \`
    ...
    \${l.draft ? \`<div class="dp-section">
      ...
      <div class="dp-draft">\${esc(l.draft)}</div>
    </div>\` : ''}
